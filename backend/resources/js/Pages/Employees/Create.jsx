...
export default function EmployeesCreate({ departments }) {
    ...
    return (
        <AuthenticatedLayout header="Personnel Acquisition">
                ...
                >
                    <div className="p-8 md:p-12">
                        <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                <h2 className="text-4xl font-serif font-bold text-white tracking-tight">Employee Onboarding</h2>
                                <p className="text-gray-400 text-sm mt-1">Register a new professional asset into the organizational matrix.</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <InputGroup label="Email Address" icon={Mail} error={errors.email}>
                                    <input 
                                        type="email" 
                                        placeholder="j.wick@industry.com"
                                        value={data.email} 
                                ...
                                <InputGroup label="Primary Department" icon={Building2} error={errors.department_id}>
                                    <select 
                                        ...
                                        className={inputClasses}
                                    >
                                        <option value="" className="bg-black">Select Node</option>
                                        {departments?.map(dept => (
                                            <option key={dept.id} value={dept.id} className="bg-black">{dept.name}</option>
                                        ))}
                                    </select>
                                </InputGroup>
                                ...
                                <InputGroup label="Operational Role" icon={Briefcase} error={errors.role}>
                                    ...
                                    >
                                        ...
                                        <option className="bg-black">Supervisor</option>
                                        <option className="bg-black">Staff</option>
                                        <option className="bg-black">Intern</option>
                                    </select>
                                </InputGroup>
