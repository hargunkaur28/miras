...
export default function DepartmentsEdit({ department }) {
    ...
    return (
        <AuthenticatedLayout header={`Modify Department: ${department.name}`}>
                ...
                >
                    <div className="p-8 md:p-12">
                        <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-white">Refine Department</h2>
                                <p className="text-gray-500 text-sm">Adjust the operational parameters for this functional unit.</p>
                            </div>
                        </div>
