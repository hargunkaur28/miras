...
export default function SalesOrdersEdit({ salesOrder, customers }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        patch(route('sales-orders.update', salesOrder.id));
    };

    return (
        <AuthenticatedLayout header={`Modify Order: ${salesOrder.so_number}`}>
                        ...
                        <div className="glass-card rounded-3xl p-8 relative overflow-hidden">
                            <div className="relative z-10">
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <div>
                                        <h2 className="text-xl font-bold text-white tracking-tight">Order Modification</h2>
                                        <p className="text-gray-500 text-sm">Adjust transaction parameters and fulfillment status.</p>
                                    </div>
                                </div>
                    ...
                    <div className="space-y-6">
                        <div className="glass-card rounded-3xl p-6 border-l-4 border-emerald-500/50">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center text-xs">
                                    ...
                                    <span className="px-2 py-0.5 rounded bg-primary/10 text-primary font-black uppercase text-[10px] tracking-widest">{salesOrder.status}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="glass-card rounded-3xl p-6 bg-white/[0.02] border border-white/5">
                            ...
                            <p className="text-[11px] text-gray-600 leading-relaxed">
                                Modifying historical order values will affect financial reporting and inventory valuation metrics for the current period.
                            </p>
                        </div>
                    </div>
                </div>
