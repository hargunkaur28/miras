...
export default function SuppliersEdit({ supplier }) {
    ...
    return (
        <AuthenticatedLayout header={`Modify Partner: ${supplier.name}`}>
                ...
                >
                    <div className="p-8 md:p-12">
                        <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-white">Refine Partner Profile</h2>
                                <p className="text-gray-500 text-sm">Update the strategic parameters for your vendor partnership.</p>
                            </div>
                        </div>
