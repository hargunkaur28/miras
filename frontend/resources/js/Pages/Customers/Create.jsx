...
export default function CustomersCreate() {
    ...
    return (
        <AuthenticatedLayout header="Client Acquisition">
                ...
                >
                    <div className="p-8 md:p-12">
                        <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-white">New Client Profile</h2>
                                <p className="text-gray-500 text-sm">Onboard a new strategic partner into your customer relationship matrix.</p>
                            </div>
                        </div>
